...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            img = (ImageView) detailsFragment.findViewById(R.id.poster);
            ...
            avg = (TextView) detailsFragment.findViewById(R.id.vote_average);
            test = (TextView) detailsFragment.findViewById(R.id.test);
            ...
            if(movie != null) {
                ...
                AsyncTask<Movie, Integer, Movie> asyncTask = new AsyncTask<Movie, Integer, Movie>() {
                    ...
                    protected void onPostExecute(Movie s) {
                        ...
                        avg.append(" " + movie.getUserRating());
